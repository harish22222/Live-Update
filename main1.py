...
wd = webdriver.Chrome(r'D:\c\chromedriver.exe',options=CO)
...
wd.get(site3)
wd.implicitly_wait(wait_imp)
total_3 = wd.find_element_by_xpath("/html/body/div/div/div/section[1]/div/div/div[2]/div[2]/div/span[2]")
Death_3 = wd.find_element_by_xpath("/html/body/div/div/div/section[1]/div/div/div[1]/div[2]/ul/li[3]/strong[2]")
Recovered_3 = wd.find_element_by_xpath("/html/body/div/div/div/section[1]/div/div/div[1]/div[2]/ul/li[2]/strong[2]")
print ("Government         {}        {}        {} ".format(total_3.text,Recovered_3.text,Death_3.text))

wd.get(site4)
wd.implicitly_wait(wait_imp)
total_4 = wd.find_element_by_xpath("/html/body/div[1]/div[1]/div/div/div/main/div/div/section/div/div[2]/div[2]/div[1]")
Death_4 = wd.find_element_by_xpath("/html/body/div[1]/div[1]/div/div/div/main/div/div/section/div/div[2]/div[4]/div[1]")
Recovered_4 = wd.find_element_by_xpath("/html/body/div[1]/div[1]/div/div/div/main/div/div/section/div/div[2]/div[5]/div[1]")
print ("Johns-Hopkins      {}            {}                     {} \n".format(total_4.text,Recovered_4.text,Death_4.text))

wd.get("https://covid19.who.int/region/searo/country/in")
wd.implicitly_wait(wait_imp)
w_total = wd.find_element_by_xpath("/html/body/div[1]/div[1]/div/div[4]/div[3]/div[2]/div[1]/div/span[1]")
w_death = wd.find_element_by_xpath("/html/body/div[1]/div[1]/div/div[4]/div[3]/div[2]/div[1]/div/span[1]")
print("WHO-Global         {}                  death            {}         \n" .format(w_total.text ,w_death.text))


wd.get("https://covid19.who.int/?gclid=CjwKCAjw47eFBhA9EiwAy8kzNNvUqFG_5acHgjmnInidrALUa5eJvRkZc2ya_qzlXcj4XvQwzOSodRoC-pUQAvD_BwE")
total_c = wd.find_element_by_xpath("/html/body/div[1]/div[1]/div/div[4]/div[3]/div[2]/div[1]/div[1]/div/span[1]")
